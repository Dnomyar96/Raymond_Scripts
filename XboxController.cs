        ...
        ///  XboxController.cs Mapping                                         11-11-2015       Versie: 3   ///
        ///////////////////////////////////////////////////////////////////////////////////////////////////////
...
public class XboxController : MonoBehaviour
{
    ...
    void Movement()
    {
        ...
        // in dit voorbeeld heb ik 0.8 gebruikt om de deadzone aan te duiden.
        ...
        if (Input.GetAxisRaw("360_Axis_RightStick_H")> 0.5|| Input.GetAxisRaw("360_Axis_RightStick_H") < -0.5)
         {
                ...
                Debug.Log(Input.GetAxis("360_Axis_RightStick_H"));
